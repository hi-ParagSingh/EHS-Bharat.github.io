(function () {
  ...
  let servies_data = [
    ...
    },
    {
      ...
      description:
        "Standards<br/>Process safety management (PSM) is addressed in specific standards for general industry and construction.<br/><br/>Hazard Recognition<br/>Provides references that help begin a PHA by recognizing process hazards.<br/><br/>Evaluation and Control<br/>Provides references that may aid in evaluating and controlling process hazards in the workplace.<br/><br/>Additional Resources<br/>Provides links and references to additional resources related to process safety management.",
    },
  ];
